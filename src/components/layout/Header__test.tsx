...
export const Header__test = () => {
    ...
    return (
      ...
      <header className="py-1 px-1 lg:px-4">
        {/* <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8"> */}
        {/* <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"> */}
        <div className="container mx-auto">
          {/* <div className="flex h-16 items-center justify-between"> */}
          <div className="flex items-center justify-between gap-1 md:gap-16 bg-glass rounded-xl px-1 py-1 md:px-4 md:py-3 flex-wrap overflow-hidden">
                ...
                <ul className="flex items-center gap-6 text-sm">
                  {N1_links.map((link) => (
                    <li key={link.href}>
                      ...
                      <Link to={link.href} className="transition">
                        {link.label}
                      </Link>
                    </li>
                  ))}
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <Link
                  className="btn__login rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium shadow-sm"
                  to="/login"
                >
                  Login
                </Link>
  
                <div className="sm:flex">{/* hidden sm:flex */}
                  <Link
                    className="btn__register rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium"
                    to="/register"
                  >
                    Register
                  </Link>
